...
2. Find your Hollow Knight mods folder:
   ...
   - **Linux**: `~/.config/unity3d/Team Cherry/Hollow Knight/Mods\`
   - **Mac**: `~/Library/Application Support/unity.Team Cherry.Hollow Knight/Mods\`
...
Created for the Hollow Knight modding community using the [Hollow Knight Modding API](https://github.com/hk-modding/api).
